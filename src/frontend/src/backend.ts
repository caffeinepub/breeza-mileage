...
export class Backend implements backendInterface {
    ...
    async addFillUp(arg0: bigint, arg1: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFillUp(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFillUps(): Promise<Array<FillUp>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFillUps();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserFillUps(arg0: Principal): Promise<Array<FillUp>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserFillUps(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
